...
public class CheckTagActivity extends AppCompatActivity implements ListenerInterface {
    ...
    public void openPatientActivity(PatientTO patient){
        Intent intent = new Intent(this, PatientActivity.class)
                .putExtra("patient", patient);
        startActivity(intent);
    }

    public void errorMessageNoPatient(String id){
        Toast.makeText(this, "There is no patient with id: + " + id, Toast.LENGTH_SHORT).show();
    }
